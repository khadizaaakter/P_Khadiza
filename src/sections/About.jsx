...
const About = () => {
  return (
    <div id="about" className="px-5 md:px-18 pt-10 xl:pt-10 max-w-8xl mx-auto">
      ...
      <div
        className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center bg-gradient-to-br from-zinc-900 to-zinc-800 rounded-xl p-8 md:p-10 shadow-lg relative overflow-hidden"
      >
        ...
        {/* Text Section */}
        <div className="text-white space-y-3 text-center md:text-left self-start">
